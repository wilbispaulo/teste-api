...
const butGerarA5fv = document.getElementById('gerar2');
const butGerarA4 = document.getElementById('gerar3');
const butGerar3S = document.getElementById('gerar4');
...
butGerarA5.addEventListener('click', async function (e) {
    ...
    const result = await generatePdfA5f(
        inputSerie.value,
        inputFrom.value,
        inputTo.value
    );
...
butGerarA5fv.addEventListener('click', async function (e) {
    e.preventDefault();
    if (inputSerie.value === '') {
        alert("Input field SERIE don't be empty!");
        return;
...
butGerar3S.addEventListener('click', async function (e) {
    e.preventDefault();
    if (inputSerie.value === '') {
        alert("Input field SERIE don't be empty!");
        return;
    ...
    const result = await generatePdf3S(
        inputSerie.value,
        inputFrom.value,
        inputTo.value
    );
...
async function generatePdfA5f(serie, fromCart, toCart) {
    const token =
...
async function generatePdfA5(serie, fromCart, toCart) {
    const token =
        'eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCJ9..X8UBU19F1QnQL1euCCbMT0uMipbvdsvqnNTmBiUFyzxSiJOd4qV1HKSS9ErEVnMREstTNTpOumDRNlCXyASfH5LXJJUYf-4O-s1N1pc_ZN12XlxX6M3bgv3QNFcSzfAv9uSrtxMmaE22GX1ljmpfxSTmcYGfMG-WPImo920jEMoF5xCz_DdFwzaCJSR0hmgHY6vKrOMGqL8squs0aBc_DVf16REJtFvDoNnjRQ5o-xBwEjn6w7e8GKnIF4L5FV30EUojYAd1UUZGMbLviys057nZoTvISvDf2-84QoWCMMsTuyhcjtEtpYFC8LeZAXTVe2ujQZn1smA-sp0mc60x6g';
    const response = await fetch(
        'http://localhost/api/bingo/pdf/generate/two_carts/two_side/A5/' +
            serie +
            '/' +
            fromCart +
            '/' +
...
async function generatePdf3S(serie, fromCart, toCart) {
    const token =
        'eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCJ9..X8UBU19F1QnQL1euCCbMT0uMipbvdsvqnNTmBiUFyzxSiJOd4qV1HKSS9ErEVnMREstTNTpOumDRNlCXyASfH5LXJJUYf-4O-s1N1pc_ZN12XlxX6M3bgv3QNFcSzfAv9uSrtxMmaE22GX1ljmpfxSTmcYGfMG-WPImo920jEMoF5xCz_DdFwzaCJSR0hmgHY6vKrOMGqL8squs0aBc_DVf16REJtFvDoNnjRQ5o-xBwEjn6w7e8GKnIF4L5FV30EUojYAd1UUZGMbLviys057nZoTvISvDf2-84QoWCMMsTuyhcjtEtpYFC8LeZAXTVe2ujQZn1smA-sp0mc60x6g';
    const response = await fetch(
        'http://localhost/api/bingo/pdf/generate/three_series/one_cart/two_side/A4/' +
            serie +
            '/' +
            fromCart +
            '/' +
